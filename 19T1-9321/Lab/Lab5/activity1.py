...
api = Api(app,
            default="Books",
            title="Book Dataset",
            description="This is just a simple example to show how to publish data as a service")
...
class BookList(Resource):
    ...
    def get(self):
        ...
        if order_by:
            df.sort_value(by=order_by, inplace = True, ascending=ascending)
    ...
    def post(self):
        ...
        if 'Identifier' not in book:
            return {"message: Mising Identifier"}, 400
...
class Books(Resource):
    ...
    def put(self, id):
        ...
        if 'Identifer' in book and id != book['Identifer']:
